 ...
 */
final class Version20220620125934 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE genres CHANGE nom name VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE genres ADD nom VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP name');
