 ...
 */
final class Version20220308133155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE scan CHANGE scan image VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE scan ADD scan VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP image');
