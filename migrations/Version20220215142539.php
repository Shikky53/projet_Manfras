 ...
 */
final class Version20220215142539 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manga CHANGE nom_auth nom_du_createur VARCHAR(255) NOT NULL');
    }
